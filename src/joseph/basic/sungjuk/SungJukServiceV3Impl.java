...
public class SungJukServiceV3Impl implements SungJukServiceV3 {
    ...
    //멤버변수 선언(class variable)
    //입력받은 모든 성적데이터를 저장하는 동적배열 변수 선언
    List<SungJukVO> sjdata = new ArrayList<>();
    SungJukVO sj = null;
    //성적데이터를 저장해둘 파일경로 지정
    String fpath = "/Users/josephlee/Downloads/SungJuk.data";
    String fpath2 = "/Users/josephlee/Downloads/SungJuk.csv";
    String fpath3 = "/Users/josephlee/Downloads/SungJuk.json";
    ...
    public void newSungJuk() {
        ...
        try {
            ...
            return; // 오류발생시 실행을 중단하고 main으로 복귀
            // return 문  기능 : 호출값 반환 , 처음으로 다시 복귀
        }
    ...
    public void initSungJuk2() {
        //try - with - resources 라는 구문을 지원한다
    ...
    public void saveSungJuk2() {
        ...
        //Java JDK7 부터는 자원을 쉽게 해제할 수 있도록
        //try - with - resources 라는 구문을 지원한다
