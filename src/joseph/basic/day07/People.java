...
public class People {
    public static void main(String[] args) {
       //객체지향 프로그래밍 개요
        ...
        // 클래스에 정의된 필드와 기능이 셀제 메모리상에 할당된 것임
        ...
        Student s2 = new Student("201250006","송혜교","서울영등포구","1998.9.17","컴퓨터","301");
    ...
    // 고객 클래스  기존 방식으로 정의
    static class Person {
        //변수 선언(속성 property,필드 field, 멤버 member)
        private String name;
        private String job;
