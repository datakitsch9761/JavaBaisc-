...
public class Serialization {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        //직렬화
        //문자단위 파일 입출력시 저장 데이터들은 모두 문자처럼 다뤄짐
        //문자 : 혜교 숫자 : 87 => 파일로저장 => 문자 : 혜교 , 문자 :87

        //numbers.txt에 저장된 정수를 읽어 더한 후 출력
        String fpath = "/Users/josephlee/Downloads/numbers.txt";
        ...
        //직렬화 : 데이터/객체를 바이트 형대로 저장함
        //ObjectOutputStream, ObjectInputStream 클래스를 사용한다

        //직렬화
        String fpath2 = "/Users/josephlee/Downloads/serialize.data";
