...
public class ByteStream {
    public static void main(String[] args) {
        ...
        //주로 바이너리 기반 데이터(이미지,동영상등)을 처리할때 사용
        ...
        //파일에 쓰기
        String fpath = "/Users/josephlee/Downloads/info2.txt";
        ...
        //파일에 쓰기 2
        String fpath2 = "/Users/josephlee/Downloads/info3.txt";

        //PrinterWriter 객체 초기화
        PrintWriter pw = null;
        ...
        try{
            ...
            //InputStreamreader 덕택에 한글은 제대로 출력이 된다
        ...
        try{
            ...
            } //readData에 저장된 바이트를 하나씩 꺼재 문자로 변환
            System.out.println(result);
