...
public class JavaLang {
    ...
    //Object 클래스 :
        //모든 클래스의 조상
        //toString,equals,hashCode외 6개 메서드가 정의되어 있음
        //대다수 클래스는 Object클레스가 제공하는 toString과 equals메소드를 오버라이딩해서 사용
        ...
        //-> 클래스의 멤버변수를 출력할때는 toString 메서드를 사용한다

        System.out.println(m.toString());
        //toString메서드를 이용해서 출력한다 객체에 대한 결과 값을 훨씬 용이하게 출력할 수 있다
        ...
        //   페이지당 게시물 수 10;
        //   총 페이지 수는 ?
        System.out.println(Math.ceil((double)125/10)); //-> 표현식이다

        //ex) 3.1415926에서 round 메서드를 이용해서
        //소수점 2째 자리까지 구하려면
