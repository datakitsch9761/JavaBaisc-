...
public class Exceptions {
    public static void main(String[] args) throws IOException {
        ...
        //예외 exception와 오류 error
        //자바 프로그램 작성시 문법에 맞지 않게 코드를 작성하면
        //컴파일 오류가 발생함
        //또한, 코드가 제대로 작성되었다 해도
        //실행중에 예상치 못한 상황으로 인해 오류가 발생할 수 있음(외적인 이유 때문에)

        //이처럼 프로그램 실행중에 예상치 못항 상황으로
        //프로그램의 실행에 영향을 주는 것을
        //예외와 오류로 구분할 수 있음
...
//        System.out.println(f);//해당 부분 에러 발생
//        System.out.println("프로그램 끝3\n");//해당 부분 에러 발생
       ...
       try {
           ...
           //예외 상황을 명확하게 지정하지 않음
          // ex.printStackTrace(); //오류발생 지점을 추적하는 문구
       }
       ...
       //ex) 1 ~ 9 사이 정수만 입력받아
        ...
        //명시적인 예외처리를 반드시 강제함(!!)
        //예외발생 시점은 컴파일 할때 compile time임
        //IOException
        //ClassNotFoundException

        //ex)임의의 입력받아 (이름,국어,영어,수학)을 입력받아
        // c:/Java/sungjuk.txt에 저장하는 프로그램 작성
        String sjdata = "혜교 98 45 23";
        String fpath = "c:/Java/sungjuk.txt"; //숫자를 입력해야만 텍스트 파일이 저장된다!!
        ...
        //한 곳에서 모아서 처리할 수 있음
        //또한, 메서드에 try-cat문을 사용하지 않아도 된다는 장점이 있음
