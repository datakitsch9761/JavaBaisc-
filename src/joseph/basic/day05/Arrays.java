...
public class Arrays {
	...
	public static void main(String[] args) {
		...
		// 배열생성시 몇개의 요소를 저장할것인지 객수를 미리 지정해야함
		// 해당 요서의 위치는 index라는 숫자값으로 지정한다
		// 배열의 index는 0부터 시작함
		// 1차원, 2차원, 3차원 배열까지 생성가능
		...
		// 배열의 요소를 출력하려면 배역명 [index] 형태로 사용
		...
		// Random 클래스를 잉ㅇ하면 원하는 형태의 난수 생성 가능
		int[] lotto = new int[6];
