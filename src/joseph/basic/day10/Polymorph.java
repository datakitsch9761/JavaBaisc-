...
public class Polymorph {
    public static void main(String[] args) {
        ...
        //상속관계이 있는 부모/자식 클래스/인터페이스간에
        //서로 형변환이 가능
        //이러한 형변환을 업캐스팅/다운캐스팅이라 한다
        //자식 클래스의 타입이 부모 클래스의 타입으로 바뀌는 것을
        //업 캐스팅이라 하고, 부모클래스의 타입이
        //자식 클래스의 타입으로 바귀는 것을 '다운캐스팅'이라 함
        ...
        //메서드로 구현해서 draw 호출을 수월하게 바꿔봄
        //여전히, draw메서드 호출시 동일한 클래스 타입을 사용해야 함
        //새로운 도형이 추가되면 paint메서드도 새로 추가해야함
        paint(new Line());
        paint(new Circle());
        paint(new Triangle());
