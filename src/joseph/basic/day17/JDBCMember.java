...
public class JDBCMember {
    public static void main(String[] args) {
        ...
        //테이블 컬럼 구성 : 아이디(userid), 비밀번호(passwd), 이름(name), 생년월일(birth), 성별(gender), 본인 확인 이메일(email), 휴대전화(hp),
        //자동입력 컬럼 : 회원번호(mbno - Primary Key), 가입일(regdate)
...
//         );
    ...
    //values('abc123','987xyz','홍길동','2021-04-21',0,'abc123@987xyz.com','012-3456-6789');
    ...
    //회원정보 입력받음
        ...
        System.out.println("입력순서는 아이디 -> 비밀번호 -> 이름 -> 생년원일 -> 성별 -> 이메일 -> 핸드폰 순서입니다.");
    ...
    //JDBC를 이용해서 Nmember 테이블에 회원정보 저장하기
        ...
        try(
                ...
                if (cnt >0) System.out.println("회원가입에 성공하셨습니다!!");
